...
const STATIC_NAV_ITEMS: Omit<NavigationItemDefinition, "source">[] = [
  ...
  { id: "consulting_home",      type: "STATIC", label: "Home da Consultoria",    iconKey: "Briefcase",      group: "centro_comando",     order: 2,  visible: true, canRenderWithoutDataset: true,  requiresDataset: false, requiresApproval: false, requiresConfiguredFields: false },
  { id: "minha_carteira",       type: "STATIC", label: "Minha Carteira",         iconKey: "Briefcase",      group: "centro_comando",     order: 3,  visible: true, canRenderWithoutDataset: true,  requiresDataset: false, requiresApproval: false, requiresConfiguredFields: false },
  // ── Conhecer Cliente ─────────────────────────────────────────────────────
  ...
  { id: "posvendas",             type: "STATIC", label: "Pós-vendas",              iconKey: "Wrench",        group: "diagnosticar_negocio", order: 40.5, visible: true, canRenderWithoutDataset: false, requiresDataset: true,  requiresApproval: true,  requiresConfiguredFields: false },
