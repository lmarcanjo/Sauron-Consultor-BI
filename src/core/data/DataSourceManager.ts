...
export class DataSourceManager {
  ...
  constructor() {
    ...
    if (!["SPREADSHEET_DATA", "DATABASE_DATA", "CONSULTANT_DATA", "MIXED_APPROVED_DATA"].includes(this.state.activeDataSource)) {
  ...
  private async loadFullRowsFromIndexedDB() {
    ...
    try {
      // Active workbook rows are read on demand by businessViews through getRowsPaged.
