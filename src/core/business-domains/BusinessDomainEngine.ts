  ...
  public translateToDomain(label: string): string {
    ...
    const replacements: Record<string, Record<string, string>> = {
      automotive: {
        ...
        vendedores: "Consultores de vendas",
        produto: "Veículo",
        produtos: "Veículos",
        item: "Veículo",
        itens: "Veículos",
        ...
        filial: "Concessionária",
        filiais: "Concessionárias",
        comissao: "Comissão do Consultor"
      },
      agribusiness: {
        vendedor: "Produtor",
      ...
      healthcare: {
        ...
        setor: "Internação",
        setores: "Internações",
        departamento: "Internação",
        departamentos: "Internações"
      },
      education: {
        cliente: "Aluno",
        clientes: "Alunos",
    ...
    const domainMap = replacements[domainId];
