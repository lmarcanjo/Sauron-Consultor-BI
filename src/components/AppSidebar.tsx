    ...
    <>
      ...
      <aside className={`bg-slate-900 border-r border-slate-800 flex flex-col h-screen fixed left-0 top-0 text-slate-300 z-50 transition-all duration-300 ${
        ...
        <div className="flex-1 overflow-y-auto py-4 custom-scrollbar overflow-x-hidden px-2.5 space-y-1.5">
          {[
            { title: "Projetos", id: "resumo", tab: null, icon: Briefcase },
            { title: "Centro de Comando", id: "resumo", tab: null, icon: Activity },
            { title: "Conectar Dados", id: "importacao", tab: null, icon: Database },
            { title: "Diagnóstico", id: "dre_inteligente", tab: null, icon: Target },
            { title: "Comercial", id: "comercial", tab: null, icon: Award },
            { title: "Financeiro", id: "financeiro", tab: null, icon: Calculator },
            { title: "Sessões", id: "modo_reuniao", tab: null, icon: MonitorPlay },
            { title: "Planos", id: "plano_executivo", tab: null, icon: CheckSquare },
            { title: "Pessoas", id: "comissoes", tab: null, icon: Users },
